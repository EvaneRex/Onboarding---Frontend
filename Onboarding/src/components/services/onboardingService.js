...
createOnboardingCourse(
  ...
  try {
    ...
    const response =
      await fetch(
        `${API_URL}/onboarding/${userId}/onboarding`,
        {
          method:
            'POST',
...
sendRegisterInvitation(
  ...
  try {
    ...
    const response =
      await fetch(
        `${API_URL}/onboarding/send-register-invitation/${userId}`,
        {
          method:
            'POST',
...
deleteYoutubeLink(
  ...
  try {
    ...
    const response =
      await fetch(
        `${API_URL}/onboarding/youtube-link/${linkId}`,
        {
          method:
            'DELETE',
...
deletePdfFile(
  ...
  try {
    ...
    const response =
      await fetch(
        `${API_URL}/onboarding/pdf-file/${filename}`,
        {
          method:
            'DELETE',
